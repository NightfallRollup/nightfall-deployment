...
#  Delete MongoDb (Optimist and Commitments dBs)

#  Usage
#  AWS_ACCESS_KEY_ID=<xxxx> AWS_SECRET_ACCESS_KEY=<xxxxxxxxxx> RELEASE=<xxxx> ./delete-mongo.sh
#
#  Pre-reqs
#   - VPN
...
mongosh --host ${MONGO_URL}:27017 \
 ...
 --quiet \
 --eval "db.getMongo().getDBNames().forEach(function(i){db.getSiblingDB(i).dropDatabase()})" 
