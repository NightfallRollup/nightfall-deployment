...
module.exports = {
  ...
  EXCLUDE_DIRS: 'common',
  MAX_QUEUE: 10,
  OPTIMIST_BP_WORKER_PARAMS: {
    optimistBpWorkerUrl: process.env.OPTIMIST_BP_WORKER_URL || 'http://opt-bpw',
  },
  ...
  CLIENT_AUX_WORKER_PARAMS: {
    clientAuxWorkerCount: process.env.CLIENT_AUX_WORKER_COUNT || 2,
    clientAuxWorkerUrl: process.env.CLIENT_AUX_WORKER_URL || 'http://client-auxw',
  },
  CLIENT_BP_WORKER_PARAMS: {
    clientBpWorkerUrl: process.env.CLIENT_BP_WORKER_URL || 'http://client-bpw',
  },
  ...
  HASH_TYPE: process.env.HASH_TYPE || 'poseidon',
  TXHASH_TREE_HASH_TYPE: 'keccak256',
  STATE_GENESIS_BLOCK: process.env.STATE_GENESIS_BLOCK,
  STATE_SYNC_BLOCKS_CHUNK: process.env.STATE_SYNC_BLOCKS_CHUNK || 1000,
  ...
  PROVER_TYPE: process.env.PROVER_TYPE || 'snarkjs',
  ...
  CBDC_PUBLISHER_ENABLE: process.env.CBDC_PUBLISHER_ENABLE || 'true',
  ...
  ENVIRONMENTS: {
    ...
    localhost: {
      ...
      clientApiAuxUrl: 'http://localhost:3050',
      optimistApiUrl: process.env.OPTIMIST_HOST
        ? `http://${process.env.OPTIMIST_HOST}:${process.env.OPTIMIST_PORT}`
        : 'http://localhost:8081',
      optimistApiBaUrl: 'http://localhost:3030',
      optimistApiBpUrl: 'http://localhost:3040',
      optimistWsUrl: process.env.OPTIMIST_HOST
        ? `ws://${process.env.OPTIMIST_HOST}:${process.env.OPTIMIST_WS_PORT}`
        : 'ws://localhost:8082',
      optimistWsBaUrl: process.env.OPTIMIST_WS_BA_URL || 'ws://localhost:3031',
      optimistWsBpUrl: process.env.OPTIMIST_WS_BP_URL || 'ws://localhost:3041',
      proposerBaseUrl: process.env.PROPOSER_HOST
        ? `http://${process.env.PROPOSER_HOST}:${process.env.PROPOSER_PORT}`
        : 'http://localhost:8092',
      adversarialOptimistApiUrl: 'http://localhost:8088',
      adversarialOptimistWsUrl: 'ws://localhost:8089',
      adversarialOptimistApiBaUrl: 'http://localhost:3032',
      adversarialOptimistWsBaUrl: 'ws://localhost:3033',
      adversarialClientApiUrl: 'http://localhost:8093',
      adversarialClientApiTxUrl: 'http://localhost:3012',
      adversarialClientApiBpUrl: 'http://localhost:3022',
      adversarialClientWsUrl: 'ws://localhost:8094',
      web3WsUrl:
    ...
    aws: {
      ...
      clientApiAuxUrl: process.env.CLIENT_AUX_WORKER_URL || 'http://localhost:3050',
      optimistApiUrl: `https://${process.env.OPTIMIST_HTTP_HOST}`,
      optimistWsUrl: `wss://${process.env.OPTIMIST_HOST}`,
      optimistApiBaUrl: `https://${process.env.OPTIMIST_BA_WORKER_HOST}`,
      optimistApiBpUrl: `https://${process.env.OPTIMIST_BP_WORKER_HOST}`,
      optimistWsBaUrl: `wss://${process.env.OPTIMIST_BA_WORKER_WS_HOST}`,
      optimistWsBpUrl: `wss://${process.env.OPTIMIST_BP_WORKER_WS_HOST}`,
  ...
  TEST_OPTIONS: {
    ...
    clientApiUrls: {
      client1: process.env.CLIENT1_API_URL || 'http://localhost:8080',
      client2: process.env.CLIENT2_API_URL || 'http://localhost:8093',
    },
    clientApiTxUrls: {
      client1: process.env.CLIENT1_API_TX_URL || 'http://localhost:3010',
      client2: process.env.CLIENT2_API_TX_URL || 'http://localhost:3012',
    },
    clientApiBpUrls: {
      client1: process.env.CLIENT1_API_BP_URL || 'http://localhost:3020',
      client2: process.env.CLIENT2_API_BP_URL || 'http://localhost:3022',
    },
    regulatorApiUrls: {
      regulator1: process.env.REGULATOR1_API_URL || 'http://localhost:8090',
      regulator2: process.env.REGULATOR2_API_URL || 'http://localhost:8095',
    },
    regulatorApiBpUrls: {
      regulator1: process.env.REGULATOR1_API_BP_URL || 'http://localhost:4030',
      regulator2: process.env.REGULATOR2_API_BP_URL || 'http://localhost:4032',
    },
    optimistApiUrls: {
      optimist1: process.env.OPTIMIST1_API_URL || 'http://localhost:8081',
      optimist2: process.env.OPTIMIST2_API_URL || 'http://localhost:8088',
    },
    optimistApiBpUrls: {
      optimist1: process.env.OPTIMIST1_API_BP_URL || 'http://localhost:3040',
      optimist2: process.env.OPTIMIST2_API_BP_URL || 'http://localhost:3042',
    },
    optimistApiBaUrls: {
      optimist1: process.env.OPTIMIST1_API_BA_URL || 'http://localhost:3030',
      optimist2: process.env.OPTIMIST2_API_BA_URL || 'http://localhost:3032',
    },
    optimistWsUrls: {
      optimist1: process.env.OPTIMIST1_WS_URL || 'ws://localhost:8082',
      optimist2: process.env.OPTIMIST2_WS_URL || 'ws://localhost:8089',
    },
    optimistWsBpUrls: {
      optimist1: process.env.OPTIMIST1_WS_BP_URL || 'ws://localhost:3041',
      optimist2: process.env.OPTIMIST2_WS_BP_URL || 'ws://localhost:3043',
    },
    optimistWsBaUrls: {
      optimist1: process.env.OPTIMIST1_WS_BA_URL || 'ws://localhost:3031',
      optimist2: process.env.OPTIMIST2_WS_BA_URL || 'ws://localhost:3033',
    },
    signingKeys: {
      walletTest:
    ...
    zkpPublicKeys: {
      user1:
        ...
        '0x80d5ed4c6c7a9dff2f5e38533c0673e252d0e761a621fb01d75040da65a54a4a',
      user2:
        process.env.USER2_COMPRESSED_ZKP_PUBLIC_KEY ||
        '0x1ddf24a69680d5cd979cbb958d508e7fbc80c1f66fbeda2c628fe8cc7098856e',
    },
    mnemonics: {
      user1:
  ...
  SIGNATURES: {
    ...
    TRANSACTION:
      '(uint256,uint256[],bytes32,bytes32,bytes32,bytes32[],bytes32[],bytes32[2],uint256[4],bytes32)',
    PROPOSE_BLOCK: [
  ...
  NIGHTFALL_REGULATOR_PRIVATE_KEY: process.env.NIGHTFALL_REGULATOR_PRIVATE_KEY,
  TIMER_CHECK_EXPIRED_TRANSACTIONS: process.env.TIMER_CHECK_EXPIRED_TRANSACTIONS || 60000,
};
