...
class ScheduleStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const ecsScheduleFnc = new Function(this, `${envAttr.name}-ecsScheduleFnc`, {
      description: 'Lambda ECS Service Mgt Function',
      functionName: `${envAttr.name}-ecsScheduleFnc`,
    ...
    ecsScheduleFnc.addToRolePolicy(
      new iam.PolicyStatement({
        sid: 'ECSServices',
        resources: ['*'],
        actions: ['ecs:ListServices', 'ecs:ListClusters'],
      }),
    );
